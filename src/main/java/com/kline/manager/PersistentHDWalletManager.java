package com.kline.manager;

import com.kline.common.TokenUtils;
...
public class PersistentHDWalletManager {
    ...
    public PersistentHDWalletManager(String rpcUrl) throws Exception {
        this.web3j = Web3j.build(new HttpService(rpcUrl));
        initializeOrLoadMasterWallet();
    }

    public PersistentHDWalletManager(String rpcUrl, Map<String, String> tokenConfigs) throws Exception {
        this.web3j = Web3j.build(new HttpService(rpcUrl));
    ...
    private void loadExistingWallet(File walletFile, File mnemonicFile) throws Exception {
        ...
        System.out.println("Loaded existing wallet. Master address: " + masterCredentials.getAddress());
    }
    ...
    private void createNewWallet(File walletFile, File mnemonicFile) throws Exception {
        ...
        System.out.println("Created new wallet. Master address: " + masterCredentials.getAddress());
        System.out.println("Mnemonic: " + mnemonicPhrase);
        System.out.println("IMPORTANT: Backup the mnemonic phrase securely!");
    }
        ...
        for (int i = 0; i < nextChildIndex; i++) {
            ...
            if (ethBalance.compareTo(estimatedGasCost) < 0) {
                ...
                if (!sendGasFunds(childAddress, estimatedGasCost)) {
                    System.out.println("主账户余额不足，无法补充 Gas");
                    continue;
                }
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 示例用法
        PersistentHDWalletManager manager = new PersistentHDWalletManager(
                "https://sepolia.infura.io/v3/57388f5634fd4ef6b9ed09b66929c1e5"
        ,tokenConfigs);

        // 为用户生成新地址
        /*String userAddress = manager.generateNewAddress();
        System.out.println("Generated new user address: " + userAddress);

        System.out.println("主钱包地址:"+manager.getMasterAddress());
        System.out.println("主钱包私钥:"+manager.getMasterPrivateKey());*/
        ...
        results.forEach((symbol, receipts) -> {
            ...
            receipts.forEach(r -> System.out.println("  TxHash: " + r.getTransactionHash()));
        });
    }
}